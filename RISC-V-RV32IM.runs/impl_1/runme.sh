...
HD_PWD='D:/verilog_projects/RISC-V-RV32IM coppy 2/RISC-V-RV32IM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RiscV_IM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_RiscV_IM.tcl -notrace
