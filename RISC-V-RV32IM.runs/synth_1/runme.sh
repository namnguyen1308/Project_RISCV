...
HD_PWD='D:/verilog_projects/RISC-V-RV32IM coppy 2/RISC-V-RV32IM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_RiscV_IM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_RiscV_IM.tcl
